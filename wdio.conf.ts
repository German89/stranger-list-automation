...
export const config: WebdriverIO.Config = {
    ...
    // },
         ...
         * Take a screenshot if the test fail, create the screenshot folder in case it does not exist
         * @param {object}  test test object
         * @param _context scope object the test was executed with
         * @param error error object in case the test fails, otherwise `undefined`
         */
        ...
        afterTest: async function (test, _context,  { error }) {
            if (error) {
                ...
                if (!fs.existsSync("./screenshot/")){
                    console.log("Creating the screenshot directory");
                    fs.mkdirSync("./screenshot");
                }
                let title = test.parent + '-' + test.title
                console.log('Taking screenshot to the ./screenshot folder  -> ' + title);
                await browser.saveScreenshot("./screenshot/" + title+'.png');
            }
        },
